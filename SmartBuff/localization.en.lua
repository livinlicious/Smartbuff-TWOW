...
SMARTBUFF_DRUID_TREE = "Tree of Life Form";
SMARTBUFF_DRUID_TRACK = "Track Humanoids";
SMARTBUFF_DRUID = { };
SMARTBUFF_DRUID[1] = {"Mark of the Wild", 30, SMARTBUFF_CONST_GROUP, {1,10,20,30,40,50,60}, "WPET;" .. SMARTBUFF_DRUID_TREE, "Gift of the Wild", 60, {50,60}, {"Wild Berries","Wild Thornroot"}};
SMARTBUFF_DRUID[2] = {"Thorns", 10, SMARTBUFF_CONST_GROUP, {6,14,24,34,44,54}, "MAGE;PRIEST;WARLOCK;WPET;" .. SMARTBUFF_DRUID_MOONKIN .. ";" .. SMARTBUFF_DRUID_TREE};
SMARTBUFF_DRUID[3] = {"Omen of Clarity", 10, SMARTBUFF_CONST_SELF, nil, SMARTBUFF_DRUID_MOONKIN .. ";" .. SMARTBUFF_DRUID_TREE};
SMARTBUFF_DRUID[4] = {"Barkskin", 0.25, SMARTBUFF_CONST_SELF, nil, SMARTBUFF_DRUID_MOONKIN .. ";" .. SMARTBUFF_DRUID_TREE};
SMARTBUFF_DRUID[5] = {"Nature's Grasp", 0.75, SMARTBUFF_CONST_SELF, nil, SMARTBUFF_DRUID_MOONKIN .. ";" .. SMARTBUFF_DRUID_TREE};
...
-- Stones and oils
SMARTBUFF_WEAPON = { };
SMARTBUFF_WEAPON[1]  = {"Rough Sharpening Stone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[2]  = {"Coarse Sharpening Stone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[3]  = {"Heavy Sharpening Stone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[4]  = {"Solid Sharpening Stone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[5]  = {"Dense Sharpening Stone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[6]  = {"Elemental Sharpening Stone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[7]  = {"Rough Weightstone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[8]  = {"Coarse Weightstone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[9]  = {"Heavy Weightstone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[10] = {"Solid Weightstone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[11] = {"Dense Weightstone", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[12] = {"Shadow Oil", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[13] = {"Frost Oil", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[14] = {"Minor Mana Oil", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[15] = {"Lesser Mana Oil", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[16] = {"Brilliant Mana Oil", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[17] = {"Minor Wizard Oil", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[18] = {"Lesser Wizard Oil", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[19] = {"Wizard Oil", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};
SMARTBUFF_WEAPON[20] = {"Brilliant Wizard Oil", 30, SMARTBUFF_CONST_INV, nil, SMARTBUFF_DRUID_TREE};

SMARTBUFF_WEAPON_STANDARD = {"Daggers", "Axes", "Swords", "Maces", "Staves", "Fist Weapons", "Polearms", "Dagger", "Axe", "Sword", "Mace", "Staff", "Fist Weapon", "Polearm"};
SMARTBUFF_WEAPON_BLUNT = {"Maces", "Staves", "Fist Weapons", "Mace", "Staff", "Fist Weapon"};
SMARTBUFF_WEAPON_BLUNT_PATTERN = "Weightstone$";
SMARTBUFF_WEAPON_SHARP = {"Daggers", "Axes", "Swords", "Polearms", "Dagger", "Axe", "Sword", "Polearm"};
